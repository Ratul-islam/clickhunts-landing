  ...
  const features = [
    {
      ...
      description:
        "Access high-quality, targeted traffic from diverse channels",
    },
    {
        ...
        <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="flex-1 max-w-xl">
              <div className="mb-8">
                ...
                <p className="text-lg text-gray-600">
                  Join our premium network to access exclusive offers and
                  industry-leading tools designed to boost your revenue.
                </p>
              </div>
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Launch and scale your campaigns with our advanced platform. Get
              access to premium traffic sources and expert optimization support.
            </p>
